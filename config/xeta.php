...
return [
    'Author' => [
        'full_name' => 'Emocean Studios',
    ],
    'Site' => [
        'name' => 'IN A BIT',
        'description' => 'WHG.Net aims to provide only the most reliable and highest quality hydroponic nutrients and hardware supplies.',
        'github_url' => 'https://github.com/Xety/Xeta',
        'analytics_tracker_code' => 'UA-46783652-7',
